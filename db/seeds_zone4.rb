...
',
  ...
  task_number = zone.new_task_number
  bonus = 400
  task = Task.create(number: task_number, name: "На гбере огдноо из вликеих доомв Втресореса ибозорбёжн злооотй лев на ксонмрам плое. Кукаю чтась допхеса вы удивуите, пянов, что я иемю видву?
