...
<b>Примечание</b><br>
Это общее задание для основной и бонусной линеек - из-за слёта основной локации.<br>
Заезд на локацию неявный. Ориентируйтесь на башенный кран. И, да, В БОНУСЕ он играет. На соседние территории не светить.',
                     zone: zone)
