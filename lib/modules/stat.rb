  ...
  class << self
    ...
    def hold_bonuses
      ...
      Team.all.each do |team|
        ...
        Zone.all.each do |zone|
          ...
          bonus = 0
          last_hold = nil
          ZoneHolder.where(zone_id: zone.id).order(:created_at).each do |hold|
          ...
          if last_hold.try(:team_id) == team.id
            bonus += ((Time.parse('2013-04-14 08:00:00') - last_hold.created_at).to_i / 1800) * 45
          end
    ...
    def reprocess
      log = [
             ...
             ['06:59:00','free','принят','free','4','0',100,100,'adm_garem@ex.ua'],
             ['06:59:35','free','принят','free','4','0',100,100,'adm_garem@ex.ua'],
             ['06:59:53','free','принят','free','4','0',100,100,'adm_garem@ex.ua'],
             ['07:00:05','free','принят','free','4','0',100,100,'adm_garem@ex.ua'],
             ['07:00:16','free','принят','free','4','0',100,100,'adm_garem@ex.ua'],
             ['07:00:23','free','принят','free','4','0',100,100,'adm_garem@ex.ua'],
             ['07:00:29','free','принят','free','4','0',100,100,'adm_garem@ex.ua'],
             ['07:00:35','free','принят','free','4','0',100,100,'adm_garem@ex.ua'],
             ['07:00:42','free','принят','free','4','0',100,100,'adm_garem@ex.ua'],
             ['07:00:47','free','принят','free','4','0',100,100,'adm_garem@ex.ua'],
             ['07:01:38','free','принят','free','4','0',100,100,'adm_garem@ex.ua'],
             ...
             ['06:54:53','bd22r3911','принят','2','4','1',550,550,'garem@ex.ua'],
             ...
             ['06:39:26','bd11r739','принят','2','4','1',550,550,'garem@ex.ua'],
             ...
             ['05:07:12','bd2r228311','принят','3','3','2',116,116,'styd@ex.ua'],
             ...
             ['04:20:19','bd14r274','принят','3','5','1',116,116,'styd@ex.ua'],
             ...
             ['03:49:09','Бонус Верность королю','принят','3','3','1',116,116,'styd@ex.ua'],
             ...
             ['02:44:02','bd24r7','принят','2','5','1',550,550,'garem@ex.ua'],
             ...
             ['02:38:33','bd3r817','принят','3','4','1',116,116,'styd@ex.ua'],
             ...
             ['02:31:41','bd1r171','принят','3','4','1',116,116,'styd@ex.ua'],
             ...
             ['02:06:04','Бонус Верность королю','принят','3','3','1',116,116,'styd@ex.ua'],
             ...
             ['01:37:46','bd2r3219','принят','2','2','1',550,550,'garem@ex.ua'],
             ...
             ['01:27:16','bd4r356','принят','3','1','1',116,116,'styd@ex.ua'],
             ...
             ['01:19:01','bd27r78586','принят','1','1','1',80,80,'sad@ex.ua'],
             ['01:18:16','bd29r92','принят','1','1','1',80,80,'sad@ex.ua'],
             ['01:18:07','free','принят','free','5','0',100,100,'adm_garem@ex.ua'],
             ['01:17:33','free','принят','free','5','0',100,100,'adm_garem@ex.ua'],
             ['01:16:47','bd21r7','принят','1+','2','1',100,100,'garem@ex.ua'],
             ['01:15:29','bd18r51','принят','1','1','1',80,80,'styd@ex.ua'],
             ['01:15:29','br3d6571','принят','1','1','1',80,80,'sad@ex.ua'],
             ['01:14:30','737сандор','принят','null','1','7',200,200,'styd@ex.ua'],
             ['01:14:09','br2d384','принят','1','1','1',80,80,'sad@ex.ua'],
             ['01:14:08','bd15r','принят','1+','1','1',100,100,'styd@ex.ua'],
             ['01:14:02','bd24r41','принят','1','1','1',80,80,'sad@ex.ua'],
             ['01:13:28','bd7r225','принят','1+','1','1',100,120,'sad@ex.ua'],
             ['01:12:46','br3d1861','принят','3','7','1',116,116,'viceversa@ex.ua'],
             ['01:12:46','bd18r51','принят','1','1','1',80,80,'sad@ex.ua'],
             ['01:11:57','Бонус Удар дракона','принят','null','6','6',200,200,'viceversa@ex.ua'],
             ['01:11:29','bd3r4142','принят','1+','7','2',100,100,'ktozdes@ex.ua'],
             ['01:11:21','bd17r63','принят','1','1','1',80,80,'sad@ex.ua'],
             ...
             ['00:39:09','bd22r38','принят','2','2','1',550,550,'garem@ex.ua'],
             ...
             ['23:55:12','br3d41172667','принят','1','4','1',80,80,'sad@ex.ua'],
             ...
             ['23:20:35','bd8r4396','принят','1','4','1',80,80,'sad@ex.ua'],
             ...
             ['23:03:46','bd12r48','принят','1','4','1',80,80,'sad@ex.ua'],
             ...
             ['23:00:38','bd23r443','принят','1','4','1',80,80,'sad@ex.ua'],
             ...
             ['22:39:51','free','принят','free','2','0',100,100,'adm_garem@ex.ua'],
             ['22:31:46','free','принят','free','2','0',100,100,'adm_garem@ex.ua'],
      ...
      teams.each do |t|
        result[t] = {}
        zones.each { |z| result[t][z] = {sum: 0, time_bonus: 0} }
          ...
          if result[ new_team ][new_zone][:sum] > zone_holders[new_zone][:sum]
            ...
            if zone_holders[new_zone][:team] == new_team
              ...
              if old_team.present?
                ...
                result[old_team][new_zone][:time_bonus] += old_bonus
              end
      ...
      zones.each do |zone|
        ...
        begin
          ...
          result[old_team][zone][:time_bonus] += old_bonus
        rescue Exception => e
          debugger
          puts [zone, e]
        end
      ...
      teams.each do |team|
        ...
        zones.each do |zone|
          ...
          bonus += result[team][zone][:time_bonus] || 0
        end
        result[team]["8"] = {sum: sum, time_bonus: bonus}
      end
