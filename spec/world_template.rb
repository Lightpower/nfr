...
def create_simple_game
  Team.create(name: 'Boltons', alternative_name: 'DRузья',    image_url: '/images/test.png')
  Team.create(name: 'Trants',  alternative_name: 'DRakoshki', image_url: '/images/test2.png')
  User.create(email: 'bol@ex.ua', password: '123456', password_confirmation: '123456', team: Team.first)
  User.create(email: 'tra@ex.ua', password: '123456', password_confirmation: '123456', team: Team.last)
